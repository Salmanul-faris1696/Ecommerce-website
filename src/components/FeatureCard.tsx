...
const FeatureCard : React.FC<propsType> = ({img , name, price}) => {
    ...
    <div className="border border-gray-200 hover:border-gray-300 hover:scale-105 transition-transform rounded-lg relative">
        ...
        <div className="space-y-2 relative p-4 ">
            <div className="text-yellow-400 flex gap-[2px] text-[20px] ">
                ...
                <button className="absolute -top-4 right-2 bg-accent text-white text-[28px] w-[50px] h-[50px] rounded-full grid items-center  justify-center cursor-pointer" onClick={addProductToCart}>
                    <AiOutlineShopping />
